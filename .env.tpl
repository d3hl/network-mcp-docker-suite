...
ENABLE_THOUSANDEYES_MCP=false                      # ThousandEyes Monitoring (Port 8004)
ENABLE_ISE_MCP=false                               # ISE Identity Services (Port 8005)
ENABLE_SPLUNK_MCP=false                            # Splunk Log Analysis (Port 8006)
ENABLE_PROMETHEUS_MCP=false                        # Prometheus Metrics (Port 8007)
ENABLE_CLICKHOUSE_MCP=false                       # ClickHouse Syslog (Port 8008)
ENABLE_GITLAB_MCP=false                            # GitLab CI/CD (Port 8009)
